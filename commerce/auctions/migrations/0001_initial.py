    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bid', to='auctions.bid')),
                ('comments', models.ManyToManyField(blank=True, related_name='comments', to='auctions.comments')),
                ('watchlists', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='watchlists', to='auctions.watchlists')),
            ],
        ),
        migrations.CreateModel(
            name='User',
